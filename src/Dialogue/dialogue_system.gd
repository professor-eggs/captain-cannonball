...
var dialogues_folder = "res://src/Dialogue/dialogues/"

# Base scene for question choices
var choice_scene = load("res://src/Dialogue/Choice.tscn")

# --- Required nodes
# The container node for the dialogues.
onready var frame : Node = $Frame

# The label where the text will be displayed.
onready var label : Node = $Frame/RichTextLabel

# The container node for the choices.
onready var choices : Node = $Frame/Choices

# Timer node
onready var timer : Node = $Timer

# Blinking square displayed when the text is all printed.
onready var continue_indicator : Node = $ContinueIndicator
onready var animations : Node = $AnimationPlayer

# Used for showing the avatar on the dialogue
onready var sprite_left : Node = $SpriteLeft
...
# --- Typewriter effect
# Time interval (in seconds) for the typewriter effect. Set to 0 to disable it. 
var wait_time : float = 0.02

# Duration of each pause when the typewriter effect is active.
var pause_time : float = 2.0

# The character used in the JSON file to define where pauses should be.
# If you change this you'll need to edit all your dialogue files.
var pause_char : String = '|'

# The character used in the JSON file to break lines.
# If you change this you'll need to edit all your dialogue files.
var newline_char : String = '@'

# --- Other customization options
# The AutoLoad script where the interaction log,
# quest variables, inventory and other useful data should be acessible.
onready var progress = Progress

# The dictionary on 'progress' used to keep track of interactions.
var dialogues_dict = 'dialogues'

# How much space (in pixels) should be added between the choices
# (affected by 'choice_height').
var choice_plus_y : int = 2

var active_choice : Color = Color(1.0, 1.0, 1.0, 1.0)
var inactive_choice : Color = Color(1.0, 1.0, 1.0, 0.4)

# Choice label's dimensions
var choice_height : int = 20
var choice_width : int = 250

# Vertical space (in pixels) between the bottom border of the dialogue frame
# and the last question (affectd by the 'label_margin')
var choice_margin_vertical : int = 10

# Horizontal space (in pixels) between the border
# (set in 'choice_node_alignment') of the dialogue frame
# and the questions (affectd by the 'label_margin')
var choice_margin_horizontal : int = 10

# Alignment of the choice's text. Can be 'left' or 'right'
var choice_text_alignment : String = 'right'

# Alignment of the 'Choice' node. Can be 'left' or 'right'
var choice_node_alignment : String = 'right'

# Input commmand for the navigating through question choices 
var previous_command : String = 'ui_up'

# Input commmand for the navigating through question choices
var next_command : String = 'ui_down'

# Dialog frame dimensions (in pixels)
var frame_height : int = 150 
var frame_width : int = 900

# Use to 'top' or 'bottom' to change the dialogue frame vertical alignment 
var frame_position : String = 'bottom'

# Vertical space (in pixels) between the dialogue box and the window border
var frame_margin_vertical : int = 10

# Space (in pixels) between the dialogue frame border and the text
var label_margin : int = 20

# Enable or disable the 'continue_indicator' animation when the text is
# completely displayed. If typewritter effect is disabled
# it will always be visible on every dialogue block.
var enable_continue_indicator : bool = true

# Used for polishing avatars' position. Can use negative values.
var sprite_offset : Vector2 = Vector2(30, 0)

# Offsets the name labels relative to the frame borders.
var name_offset : Vector2 = Vector2(-10, -15)

# Turn on and off the character name labels
var show_names : bool = true

# ----- /SETUP -----

# ----- DEFAULT VALUES -----
# Don't change them unless you really know what you're doing.
var id
var next_step = ''
var dialogue
var phrase = ''
